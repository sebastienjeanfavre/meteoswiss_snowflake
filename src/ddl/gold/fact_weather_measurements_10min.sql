-- ============================================================================
-- Gold Layer - Weather Measurements Fact Table
-- ============================================================================
...
-- Usage: Primary table for weather analytics and reporting
-- ============================================================================
...
-- ============================================================================
-- Contains all weather measurements at 10-minute granularity
...
COMMENT ON VIEW gold.fact_weather_measurements_10min IS
    'Business-optimized weather measurements fact table at 10-minute granularity. Contains unified, deduplicated measurements from all tiers (historical/recent/now) with business-friendly column names. Primary table for weather analytics and reporting.';
...
-- WHERE measurement_date = CURRENT_DATE - 1;
...
SELECT 'Gold layer fact_weather_measurements created successfully' AS result;
